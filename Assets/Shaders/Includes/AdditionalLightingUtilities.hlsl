...
// For CutomLitToonLit
void AdditionalLightsRadianceHalfLambert_float(float MainDiffuse, float3 MainSpecular, float3 MainColor, float3 WorldPosition, float3 WorldNormal, float3 WorldView, float Smoothness, float2 ScreenPosition,
