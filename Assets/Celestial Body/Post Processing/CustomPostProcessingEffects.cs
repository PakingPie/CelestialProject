...
{
	[SerializeField] private PostProcessingEffect[] effects;
...
// 		if (debugOceanMask) {
// 			Graphics.Blit (FindAnyObjectByType<OceanMaskRenderer> ().oceanMaskTexture, finalDestination, defaultMat);
// 		}
...
// 			Graphics.Blit (currentSource, destination, new Material (Shader.Find ("Universal Render Pipeline/Unlit")));
// 		}
// 		// Release temporary textures
// 		for (int i = 0; i < temporaryTextures.Count; i++) {
// 			RenderTexture.ReleaseTemporary (temporaryTextures[i]);
