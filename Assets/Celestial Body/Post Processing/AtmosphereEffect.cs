...
public class AtmosphereEffect
{
	...
	public void UpdateSettings(CelestialBodyGenerator generator, Material mat)
	{
		material = mat;
		...
		if (light == null)
		{
			light = GameObject.FindAnyObjectByType<SunShadowCaster>()?.GetComponent<Light>();
			// light = GameObject.FindAnyObjectByType<Light> ()?.GetComponent<Light> ();
		}
